...
keys, the extra keys default to the value of the scan's first simulation --
override any of them with repeated --fix key=value flags.
...
_phase_diagram_kymograph_<key1>_<key2>_<key3>=<value>.png
"""
import sys
...
def main():
    ...
    out_path = out_dir / f"_phase_diagram_kymograph_{key1}_{key2}{extra_suffix}.png"
